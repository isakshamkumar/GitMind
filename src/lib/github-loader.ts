...
// const docs = await loadGithubRepo("https://github.com/elliott-chong/normalhuman");

// const allEmbeddings = await Promise.all(docs.map(async (doc) => {
...
//                 where: {
//                     projectId_fileName: {
//                         projectId: 'cm2oiim3k000lka0m5117240b',
